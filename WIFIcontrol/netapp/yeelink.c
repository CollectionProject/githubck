...
/*====================下面3条为修改项目=================================================*/
#define YEELINK_ENABLE  0                                       //yeelink功能是否需要打开
static char api_key[] = "29b51243a5dbbaf15c245f69f1dd3b3d";     //API KEY 注册YEELINK的时候得到
static char status_str[] = "http://api.yeelink.net/v1.0/device/3493/sensor/4867/datapoints";
/*=================================================================================*/
...
{
	YeeClient.connected=0;
        printf("Yeelink : connect to server code : %d \n",err);

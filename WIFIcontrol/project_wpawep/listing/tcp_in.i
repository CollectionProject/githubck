...
tcp_input(struct pbuf *p, struct netif *inp)
{
  ...
  if (pbuf_header(p, -((s16_t)(((ntohs((iphdr)->_v_hl_tos) >> 8) & 0x0f) * 4))) || (p->tot_len < sizeof(struct tcp_hdr))) {
    ...
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_input: short packet (%" "4d" " bytes) discarded\n", p->tot_len);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    ;
    ;
    ;
    pbuf_free(p);
  ...
  if (inet_chksum_pseudo(p, (struct ip_addr *)&(iphdr->src),
      ...
      6, p->tot_len) != 0) {
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_input: packet discarded due to failing checksum 0x%04" "4x" "\n", inet_chksum_pseudo(p, (struct ip_addr *)&(iphdr->src), (struct ip_addr *)&(iphdr->dest), 6, p->tot_len));} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
  ...
  if(pbuf_header(p, -(hdrlen * 4))){
    ...
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_input: short packet\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    ;
    ;
    ;
    pbuf_free(p);
  ...
  if (pcb == 0) {
    ...
    for(pcb = tcp_tw_pcbs; pcb != 0; pcb = pcb->next) {
      ...
      if (pcb->remote_port == tcphdr->src &&
        ...
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_input: packed for TIME_WAITing connection.\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    ...
    for(lpcb = tcp_listen_pcbs.listen_pcbs; lpcb != 0; lpcb = lpcb->next) {
      if ((((&(lpcb->local_ip)) == 0 || (&(lpcb->local_ip))->addr == 0) ||
        ...
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_input: packed for LISTENing connection.\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
  ...
  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("+-+-+-+-+-+-+-+-+-+-+-+-+-+- tcp_input: flags ");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
  tcp_debug_print_flags((ntohs((tcphdr)->_hdrlen_rsvd_flags) & 0x3fU));
  ...
  if (pcb != 0) {
    ...
    if (pcb->refused_data != 0) {
      ...
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_input: notify kept packet\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
      ...
      if (err == 0) {
        ...
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_input: drop incoming packets, because pcb is \"full\"\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        ;
        ;
        pbuf_free(p);
        return;
      ...
      if (recv_flags & (u8_t)0x08U) {
        ...
        if (recv_data != 0) {
          ...
          if (err != 0) {
            ...
            do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_input: keep incoming packet, because pcb is \"full\"\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
          }
        }
    ...
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_input: no PCB match found, resetting.\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
...
tcp_listen_input(struct tcp_pcb_listen *pcb)
{
  ...
  if (flags & 0x10U) {
    ...
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_listen_input: ACK in LISTEN, sending reset\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    ...
    if (pcb->accepts_pending >= pcb->backlog) {
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_listen_input: listen backlog exceeded for port %" "4d" "\n", tcphdr->dest);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    ...
    pcb->accepts_pending++;
	do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_listen_input: pcb->accepts_pending++ %" "4d" "\n", pcb->accepts_pending);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
...
tcp_process(struct tcp_pcb *pcb)
{
  ...
  if (flags & 0x04U) {
    ...
    if (acceptable) {
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_process: Connection RESET\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
      ;
  ...
  switch (pcb->state) {
  case SYN_SENT:
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("SYN-SENT: ackno %" "8ld" " pcb->snd_nxt %" "8ld" " unacked %" "8ld" "\n", ackno, pcb->snd_nxt, ntohl(pcb->unacked->tcphdr->seqno));} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    ...
    if ((flags & 0x10U) && (flags & 0x02U)
      ...
      ;
      --pcb->snd_queuelen;
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_process: SYN-SENT --queuelen %" "4d" "\n", (u16_t)pcb->snd_queuelen);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
      rseg = pcb->unacked;
  ...
  case FIN_WAIT_1:
    ...
    if (recv_flags & (u8_t)0x20U) {
      if ((flags & 0x10U) && (ackno == pcb->snd_nxt)) {
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("TCP connection closed %" "4d" " -> %" "4d" ".\n", inseg . tcphdr->src, inseg . tcphdr->dest);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
...
tcp_receive(struct tcp_pcb *pcb)
{
  ...
  if (flags & 0x10U) {
    ...
    if (((s32_t)((pcb->snd_wl1)-(seqno)) < 0) ||
      ...
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: window update %" "4d" "\n", pcb->snd_wnd);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);

    } else {
      if (pcb->snd_wnd != tcphdr->wnd) {
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: no window update lastack %" "8ld" " ackno %" "8ld" " wl1 %" "8ld" " seqno %" "8ld" " wl2 %" "8ld" "\n", pcb->lastack, ackno, pcb->snd_wl1, seqno, pcb->snd_wl2);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    ...
    if (pcb->lastack == ackno) {
      ...
      if (pcb->snd_wl2 + pcb->snd_wnd == right_wnd_edge){
        ...
        if (pcb->dupacks >= 3 && pcb->unacked != 0) {
          if (!(pcb->flags & ((u8_t)0x04U))) {
            ...
            do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: dupacks %" "4d" " (%" "8ld" "), fast retransmit %" "8ld" "\n", (u16_t)pcb->dupacks, pcb->lastack, ntohl(pcb->unacked->tcphdr->seqno));} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
            ...
            if (pcb->ssthresh < 2*pcb->mss) {
              do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: The minimum value for ssthresh %" "4d" " should be min 2 mss %" "4d" "...\n", pcb->ssthresh, 2*pcb->mss);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        ...
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: dupack averted %" "8ld" " %" "8ld" "\n", pcb->snd_wl2 + pcb->snd_wnd, right_wnd_edge);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
      ...
      if (pcb->state >= ESTABLISHED) {
        if (pcb->cwnd < pcb->ssthresh) {
          ...
          do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: slow start cwnd %" "4d" "\n", pcb->cwnd);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        } else {
          u16_t new_cwnd = (pcb->cwnd + pcb->mss * pcb->mss / pcb->cwnd);
          if (new_cwnd > pcb->cwnd) {
            pcb->cwnd = new_cwnd;
          }
          do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: congestion avoidance cwnd %" "4d" "\n", pcb->cwnd);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        }
      }
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: ACK for %" "8ld" ", unacked->seqno %" "8ld" ":%" "8ld" "\n", ackno, pcb->unacked != 0? ntohl(pcb->unacked->tcphdr->seqno): 0, pcb->unacked != 0? ntohl(pcb->unacked->tcphdr->seqno) + ((pcb->unacked)->len + (((ntohs(((pcb->unacked)->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 0x01U || (ntohs(((pcb->unacked)->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 0x02U)? 1: 0)): 0);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
      ...
      while (pcb->unacked != 0 &&
        ...
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: removing %" "8ld" ":%" "8ld" " from pcb->unacked\n", ntohl(pcb->unacked->tcphdr->seqno), ntohl(pcb->unacked->tcphdr->seqno) + ((pcb->unacked)->len + (((ntohs(((pcb->unacked)->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 0x01U || (ntohs(((pcb->unacked)->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 0x02U)? 1: 0)));} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        ...
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: queuelen %" "4d" " ... ", (u16_t)pcb->snd_queuelen);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        ;
        pcb->snd_queuelen -= pbuf_clen(next->p);
        tcp_seg_free(next);

        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("%" "4d" " (after freeing unacked)\n", (u16_t)pcb->snd_queuelen);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    ...
    while (pcb->unsent != 0 &&
      ...
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: removing %" "8ld" ":%" "8ld" " from pcb->unsent\n", ntohl(pcb->unsent->tcphdr->seqno), ntohl(pcb->unsent->tcphdr->seqno) + ((pcb->unsent)->len + (((ntohs(((pcb->unsent)->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 0x01U || (ntohs(((pcb->unsent)->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 0x02U)? 1: 0)));} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
      ...
      pcb->snd_queuelen -= pbuf_clen(next->p);
      tcp_seg_free(next);
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("%" "4d" " (after freeing unsent)\n", (u16_t)pcb->snd_queuelen);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
      if (pcb->snd_queuelen != 0) {
        ;
    ...
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: pcb->rttest %" "8ld" " rtseq %" "8ld" " ackno %" "8ld" "\n", pcb->rttest, pcb->rtseq, ackno);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    ...
    if (pcb->rttest && ((s32_t)((pcb->rtseq)-(ackno)) < 0)) {
      ...
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: experienced rtt %" "4d" " ticks (%" "4d" " msec).\n", m, m * (2*250));} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
      ...
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: RTO %" "4d" " (%" "4d" " milliseconds)\n", pcb->rto, pcb->rto * (2*250));} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
  ...
  if (tcplen > 0) {
    ...
    if ((((s32_t)((pcb->rcv_nxt)-(seqno + 1)) >= 0) && ((s32_t)((pcb->rcv_nxt)-(seqno + tcplen - 1)) <= 0))){
      ...
      if (((s32_t)((seqno)-(pcb->rcv_nxt)) < 0)){
        ...
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: duplicate seqno %" "8ld" "\n", seqno);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        do { (pcb)->flags |= ((u8_t)0x02U); tcp_output(pcb); } while (0);
      }
    }
    ...
    if ((((s32_t)((seqno)-(pcb->rcv_nxt)) >= 0) && ((s32_t)((seqno)-(pcb->rcv_nxt + pcb->rcv_wnd - 1)) <= 0))){
      ...
      if (pcb->rcv_nxt == seqno) {
        ...
        if (tcplen > pcb->rcv_wnd) {
          do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: other end overran receive window" "seqno %" "8ld" " len %" "8ld" " right edge %" "8ld" "\n", seqno, tcplen, pcb->rcv_nxt + pcb->rcv_wnd);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
...
#line 1121 "..\\lwIP\\src\\core\\tcp_in.c"
        ...
        if ((ntohs((inseg . tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 0x01U) {
          do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_receive: received FIN.\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
          recv_flags |= (u8_t)0x20U;
        }

#line 1190 "..\\lwIP\\src\\core\\tcp_in.c"
        ...
        do { (pcb)->flags |= ((u8_t)0x02U); tcp_output(pcb); } while (0);
#line 1318 "..\\lwIP\\src\\core\\tcp_in.c"
  ...
  if((ntohs((tcphdr)->_hdrlen_rsvd_flags) >> 12) > 0x5) {
    ...
    for (c = 0; c < max_c; ) {
      ...
      case 0x00:
        ...
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_parseopt: EOL\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        return;
      case 0x01:
         
        ++c;
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_parseopt: NOP\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        break;
      case 0x02:
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_parseopt: MSS\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        if (opts[c + 1] != 0x04 || c + 0x04 > max_c) {
           
          do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_parseopt: bad length\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
          return;
        }
        ...
        c += 0x04;
        break;
#line 1405 "..\\lwIP\\src\\core\\tcp_in.c"
      default:
        do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_parseopt: other\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
        if (opts[c + 1] == 0) {
          do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_parseopt: bad length\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);

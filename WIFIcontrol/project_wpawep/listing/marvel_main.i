#line 1 "..\\marvel\\driver\\src\\marvel_main.c"
...
#line 2 "..\\marvel\\driver\\src\\marvel_main.c"
...
#line 3 "..\\marvel\\driver\\src\\marvel_main.c"
...
#line 4 "..\\marvel\\driver\\src\\marvel_main.c"
#line 5 "..\\marvel\\driver\\src\\marvel_main.c"
#line 6 "..\\marvel\\driver\\src\\marvel_main.c"
#line 7 "..\\marvel\\driver\\src\\marvel_main.c"
...
#line 8 "..\\marvel\\driver\\src\\marvel_main.c"
...
#line 9 "..\\marvel\\driver\\src\\marvel_main.c"
...
#line 10 "..\\marvel\\driver\\src\\marvel_main.c"
#line 11 "..\\marvel\\driver\\src\\marvel_main.c"
#line 12 "..\\marvel\\driver\\src\\marvel_main.c"
...
static struct region_cfp_table region_cfp_table[] = {
	{0x10,			 
	 ...
	 (sizeof(channel_freq_power_US_BG) / sizeof((channel_freq_power_US_BG)[0])),
	 }
	,
	{0x20,			 
	 channel_freq_power_US_BG,
	...
	{0x30,   channel_freq_power_EU_BG,
	 (sizeof(channel_freq_power_EU_BG) / sizeof((channel_freq_power_EU_BG)[0])),
	 }
	,
	{0x31,   channel_freq_power_SPN_BG,
	 (sizeof(channel_freq_power_SPN_BG) / sizeof((channel_freq_power_SPN_BG)[0])),
	 }
	,
	{0x32,   channel_freq_power_FR_BG,
	 (sizeof(channel_freq_power_FR_BG) / sizeof((channel_freq_power_FR_BG)[0])),
	 }
	,
	{0x40,   channel_freq_power_JPN_BG,
	 (sizeof(channel_freq_power_JPN_BG) / sizeof((channel_freq_power_JPN_BG)[0])),
	 }
	,
...
u16 lbs_region_code_to_index[6] =
...
static int lbs_init_adapter(struct lbs_private *priv)
{
	size_t bufsize;
	int i, ret = 0;
	static u8 gnet_bss_desc[12 * sizeof(struct bss_descriptor)];

	;
	 
	bufsize = 12 * sizeof(struct bss_descriptor);
	...
	memset(priv->current_addr, 0xff, 6);

	priv->connect_status = LBS_DISCONNECTED;
	priv->mesh_connect_status = LBS_DISCONNECTED;
	priv->secinfo.auth_mode = 0x00000001;
	priv->mode = 2;
	priv->curbssparams.channel = 6;
	priv->mac_control = 0x0001 | 0x0002;
	priv->radio_on = 1;
	priv->enablehwauto = 1;
	priv->capability = (1<<5);
	...
	if (lbs_allocate_cmd_buffer(priv)) {
		printf("Out of memory allocating command buffers\n");
		ret = -12;
		goto out;
	}
	priv->resp_idx = 0;
...
int lbs_process_event(struct lbs_private *priv, u32 event)
{
	...
	switch (event) {
	case 4:
		printf("EVENT: link sensed\n");
		break;

	case 8:
		printf("EVENT: deauthenticated\n");
	...
	case 3:
		printf("EVENT: link lost\n");
		
		break;

	case 11:
		printf("EVENT: ps sleep\n");

		 
		if (priv->psstate == PS_STATE_FULL_POWER) {
			printf("EVENT: in FULL POWER mode, ignoreing PS_SLEEP\n");
			break;
		}
	...
	case 18:
		printf("EVENT: host awake\n");
		
		break;

	case 10:
		printf("EVENT: ps awake\n");
	...
	case 14:
		printf("EVENT: UNICAST MIC ERROR\n");
		
		break;

	case 13:
		printf("EVENT: MULTICAST MIC ERROR\n");
		
		break;

	case 6:
		printf("EVENT: MIB CHANGED\n");
		break;
	case 7:
		printf("EVENT: INIT DONE\n");
		break;
	case 17:
		printf("EVENT: ADHOC beacon lost\n");
		break;
	case 25:
		printf("EVENT: rssi low\n");
		break;
	case 26:
		printf("EVENT: snr low\n");
		break;
	case 27:
		printf("EVENT: max fail\n");
		break;
	case 28:
		printf("EVENT: rssi high\n");
		break;
	case 29:
		printf("EVENT: snr high\n");
		break;
#line 393 "..\\marvel\\driver\\src\\marvel_main.c"
	default:
	...
	do{
		...
		if (priv->cmd_timed_out && priv->cur_cmd) {
			...
			if (++priv->nr_retries > 0) {
				...
				lbs_complete_command(priv, cmdnode, -60);
				priv->nr_retries = 0;
...
#line 627 "..\\marvel\\driver\\src\\marvel_main.c"
...
struct lbs_private *lbs_add_card(void *card)
{
	...
	memset(priv,0,sizeof(struct lbs_private));
	 ...
	 if (lbs_init_adapter(priv)) {
		printf("failed to initialize adapter structure.\n");
...
struct chan_freq_power *lbs_get_region_cfp_table(u8 region, int *cfp_no)
{
	...
	end = (sizeof(region_cfp_table) / sizeof((region_cfp_table)[0]));
...
void lbs_queue_event(struct lbs_private *priv, u32 event)
{
	...
	do{ priv->event_fifo->env= *(unsigned char *)&event; priv->event_fifo->len=1;}while(0);

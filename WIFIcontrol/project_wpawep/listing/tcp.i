...
tcp_close(struct tcp_pcb *pcb)
{
  ...
  switch (pcb->state) {
	  case CLOSED:
		...
		do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_close: tcp_listen_pcbs.listen_pcbs->accepts_pending-- %" "4d" "\n", tcp_listen_pcbs . listen_pcbs->accepts_pending);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
...
tcp_abandon(struct tcp_pcb *pcb, int reset)
{
  ...
  if (pcb->state == TIME_WAIT) {
    ...
    if (reset) {
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_abandon: sending RST\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
...
tcp_bind(struct tcp_pcb *pcb, struct ip_addr *ipaddr, u16_t port)
{
  ...
  do { if (!(pcb->state == CLOSED)) { do { printf("Assertion \"%s\" failed at line %d in %s\n", "tcp_bind: can only bind in state CLOSED", 267, "..\\lwIP\\src\\core\\tcp.c"); } while(0); return -13;}} while(0);
...
tcp_listen_with_backlog(struct tcp_pcb *pcb, u8_t backlog)
{
  ...
  (void)backlog;
  do { if (!(pcb->state == CLOSED)) { do { printf("Assertion \"%s\" failed at line %d in %s\n", "tcp_listen: pcb already connected", 358, "..\\lwIP\\src\\core\\tcp.c"); } while(0); return 0;}} while(0);
      ...
      err_t (* connected)(void *arg, struct tcp_pcb *tpcb, err_t err))
{
  ...
  do { if (!(pcb->state == CLOSED)) { do { printf("Assertion \"%s\" failed at line %d in %s\n", "tcp_connect: can only connected from state CLOSED", 507, "..\\lwIP\\src\\core\\tcp.c"); } while(0); return -13;}} while(0);
    ...
    if (pcb->state == SYN_SENT && pcb->nrtx == 6) {
      ...
      if (pcb->persist_backoff > 0) {
        ...
        if (pcb->unacked != 0 && pcb->rtime >= pcb->rto) {
          ...
          do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_slowtmr: rtime %" "4d" " pcb->rto %" "4d" "\n", pcb->rtime, pcb->rto);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
          ...
          pcb->cwnd = pcb->mss;
          do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_slowtmr: cwnd %" "4d" " ssthresh %" "4d" "\n", pcb->cwnd, pcb->ssthresh);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
...
tcp_fasttmr(void)
{
  ...
  for(pcb = tcp_active_pcbs; pcb != 0; pcb = pcb->next) {
    ...
    if (pcb->refused_data != 0) {
      ...
      err_t err;
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_fasttmr: notify kept packet\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    ...
    if (pcb->state == SYN_RCVD) {
      ...
      for (lpcb = tcp_listen_pcbs.listen_pcbs; lpcb != 0; lpcb = lpcb->next) {
        if ((lpcb->local_port == pcb->local_port) &&
            	(((&lpcb->local_ip) == 0 || (&lpcb->local_ip)->addr == 0) ||
             		((&pcb->local_ip)->addr == (&lpcb->local_ip)->addr))) {
              
             ;

             lpcb->accepts_pending--;
			 do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_pcb_purge: lpcb->accepts_pending-- %" "4d" "\n", lpcb->accepts_pending);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
...
tcp_debug_print(struct tcp_hdr *tcphdr)
{
  ...
  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("|    %5" "4d" "      |    %5" "4d" "      | (src port, dest port)\n", ntohs(tcphdr->src), ntohs(tcphdr->dest));} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);

  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("+-------------------------------+\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("|           %010" "8ld" "          | (seq no)\n", ntohl(tcphdr->seqno));} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);

  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("+-------------------------------+\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("|           %010" "8ld" "          | (ack no)\n", ntohl(tcphdr->ackno));} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);

  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("+-------------------------------+\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("| %2" "4d" " |   |%" "4d" "%" "4d" "%" "4d" "%" "4d" "%" "4d" "%" "4d" "|     %5" "4d" "     | (hdrlen, flags (", (ntohs((tcphdr)->_hdrlen_rsvd_flags) >> 12), (ntohs((tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) >> 5 & 1, (ntohs((tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) >> 4 & 1, (ntohs((tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) >> 3 & 1, (ntohs((tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) >> 2 & 1, (ntohs((tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) >> 1 & 1, (ntohs((tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 1, ntohs(tcphdr->wnd));} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
#line 1324 "..\\lwIP\\src\\core\\tcp.c"
...
{
  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("State: ");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
  switch (s) {
  case CLOSED:
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("CLOSED\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    break;
 case LISTEN:
   do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("LISTEN\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
   break;
  case SYN_SENT:
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("SYN_SENT\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    break;
  case SYN_RCVD:
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("SYN_RCVD\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    break;
  case ESTABLISHED:
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("ESTABLISHED\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    break;
  case FIN_WAIT_1:
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("FIN_WAIT_1\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    break;
  case FIN_WAIT_2:
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("FIN_WAIT_2\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    break;
  case CLOSE_WAIT:
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("CLOSE_WAIT\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    break;
  case CLOSING:
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("CLOSING\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    break;
  case LAST_ACK:
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("LAST_ACK\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
    break;
  case TIME_WAIT:
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("TIME_WAIT\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
   break;
  }
}

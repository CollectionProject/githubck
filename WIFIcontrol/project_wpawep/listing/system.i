...
void GPIO_Configuration(void)
{
	...
	GPIO_InitStructure.GPIO_Pin = ((u16)0x0001) | ((u16)0x0002) | ((u16)0x0004) | ((u16)0x0010) | ((u16)0x0020);
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIO_Init(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800)), &GPIO_InitStructure);
	GPIO_SetBits(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800)), ((u16)0x0001) | ((u16)0x0002) | ((u16)0x0004) | ((u16)0x0010) | ((u16)0x0020));

	GPIO_InitStructure.GPIO_Pin = ((u16)0x0002);
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;
    GPIO_Init(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00)), &GPIO_InitStructure);
	GPIO_SetBits(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00)), ((u16)0x0002));

	 
	 
	GPIO_InitStructure.GPIO_Pin =  ((u16)0x0100) | ((u16)0x0800) | ((u16)0x1000);
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;		
	GPIO_Init(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0800)), &GPIO_InitStructure);

	GPIO_InitStructure.GPIO_Pin =  ((u16)0x0020) | ((u16)0x0040) | ((u16)0x8000);
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_2MHz;
	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_IN_FLOATING;		
	GPIO_Init(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x0C00)), &GPIO_InitStructure);

...
#line 6 "..\\main\\parmcfg.c"



char marvel_mode='0';
char marvel_ssid[32]={"LXHZ"};
char marvel_key[32]= {"1234567890123"};			
char wireless_ip[4]={192,168,1,8};			
char wireless_mask[4]={255,255,255,0};			
char wireless_gw[4]={192,168,1,1};                      
char wireless_dns[4]={192,168,1,1};            
char wireless_mac[6]={0x00,0x1D,0x2f,0x00,0x4e,0x2d}; 
#line 27 "..\\main\\parmcfg.c"
...
int load_netcfg(void)
{
    ...
    if(!(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000))->IDR&(1<<0))){
        config_delay();
        if(!(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000))->IDR&(1<<0))){
            write_flash_config((u16 *)default_cfg,sizeof(default_cfg));
            while(!(((GPIO_TypeDef *) ((((u32)0x40000000) + 0x10000) + 0x1000))->IDR&(1<<0)));
            NVIC_GenerateSystemReset();
            return 0;
        }
    }
    read_flash(((u32)0x0803F800),(u16 *)str_tmp,256);
    if(len==0)
        return -1;

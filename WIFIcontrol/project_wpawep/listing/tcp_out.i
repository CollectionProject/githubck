...
{
  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_write(pcb=%p, data=%p, len=%" "4d" ", apiflags=%" "4d" ")\n", (void *)pcb, data, len, (u16_t)apiflags);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
  ...
  if (pcb->state == ESTABLISHED ||
    ...
    do { if ( ((0x80U | 0x20U | 3) & 0x80U) && ((0x80U | 0x20U | 3) & 0x80U) && ((s16_t)((0x80U | 0x20U | 3) & 0x03) >= 0x00)) { do {printf ("tcp_write() called in invalid state\n");} while(0); if ((0x80U | 0x20U | 3) & 0x08U) { while(1); } } } while(0);
    return -8;
  }
}
            ...
            u8_t flags, u8_t apiflags, u8_t optflags)
{
  ...
  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_enqueue(pcb=%p, arg=%p, len=%" "4d" ", flags=%" "4x" ", apiflags=%" "4d" ")\n", (void *)pcb, arg, len, (u16_t)flags, (u16_t)apiflags);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
  ...
  if (len > pcb->snd_buf) {
    do { if ( ((0x80U | 3) & 0x80U) && ((0x80U | 3) & 0x80U) && ((s16_t)((0x80U | 3) & 0x03) >= 0x00)) { do {printf ("tcp_enqueue: too much data (len=%" "4d" " > snd_buf=%" "4d" ")\n", len, pcb->snd_buf);} while(0); if ((0x80U | 3) & 0x08U) { while(1); } } } while(0);
  ...
  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_enqueue: queuelen: %" "4d" "\n", (u16_t)pcb->snd_queuelen);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
  ...
  if ((queuelen >= (6 * (1500 - 40))/(1500 - 40)) || (queuelen > (0xffff-3))) {
    do { if ( ((0x80U | 3) & 0x80U) && ((0x80U | 3) & 0x80U) && ((s16_t)((0x80U | 3) & 0x03) >= 0x00)) { do {printf ("tcp_enqueue: too long queue %" "4d" " (max %" "4d" ")\n", queuelen, (6 * (1500 - 40))/(1500 - 40));} while(0); if ((0x80U | 3) & 0x08U) { while(1); } } } while(0);
    ;
    pcb->flags |= ((u8_t)0x80U);
    return -1;
  }
  ...
  while (queue == 0 || left > 0) {
    ...
    if (seg == 0) {
      do { if ( ((0x80U | 2) & 0x80U) && ((0x80U | 2) & 0x80U) && ((s16_t)((0x80U | 2) & 0x03) >= 0x00)) { do {printf ("tcp_enqueue: could not allocate memory for tcp_seg\n");} while(0); if ((0x80U | 2) & 0x08U) { while(1); } } } while(0);
    ...
    if (apiflags & 0x01) {
      if ((seg->p = pbuf_alloc(PBUF_TRANSPORT, seglen + optlen, PBUF_RAM)) == 0) {
        do { if ( ((0x80U | 2) & 0x80U) && ((0x80U | 2) & 0x80U) && ((s16_t)((0x80U | 2) & 0x03) >= 0x00)) { do {printf ("tcp_enqueue : could not allocate memory for pbuf copy size %" "4d" "\n", seglen);} while(0); if ((0x80U | 2) & 0x08U) { while(1); } } } while(0);
      ...
      if ((seg->p = pbuf_alloc(PBUF_TRANSPORT, optlen, PBUF_RAM)) == 0) {
        do { if ( ((0x80U | 2) & 0x80U) && ((0x80U | 2) & 0x80U) && ((s16_t)((0x80U | 2) & 0x03) >= 0x00)) { do {printf ("tcp_enqueue: could not allocate memory for header pbuf\n");} while(0); if ((0x80U | 2) & 0x08U) { while(1); } } } while(0);
      ...
      if (left > 0) {
        if ((p = pbuf_alloc(PBUF_RAW, seglen, PBUF_ROM)) == 0) {
          ...
          pbuf_free(seg->p);
          seg->p = 0;
          do { if ( ((0x80U | 2) & 0x80U) && ((0x80U | 2) & 0x80U) && ((s16_t)((0x80U | 2) & 0x03) >= 0x00)) { do {printf ("tcp_enqueue: could not allocate memory for zero-copy pbuf\n");} while(0); if ((0x80U | 2) & 0x08U) { while(1); } } } while(0);
    ...
    if ((queuelen > (6 * (1500 - 40))/(1500 - 40)) || (queuelen > (0xffff-3))) {
      do { if ( ((0x80U | 2) & 0x80U) && ((0x80U | 2) & 0x80U) && ((s16_t)((0x80U | 2) & 0x03) >= 0x00)) { do {printf ("tcp_enqueue: queue too long %" "4d" " (%" "4d" ")\n", queuelen, (6 * (1500 - 40))/(1500 - 40));} while(0); if ((0x80U | 2) & 0x08U) { while(1); } } } while(0);
      goto memerr;
    }
    ...
    if (pbuf_header(seg->p, 20)) {
      do { if ( ((0x80U | 2) & 0x80U) && ((0x80U | 2) & 0x80U) && ((s16_t)((0x80U | 2) & 0x03) >= 0x00)) { do {printf ("tcp_enqueue: no room for TCP header in pbuf.\n");} while(0); if ((0x80U | 2) & 0x08U) { while(1); } } } while(0);
      ;
      goto memerr;
    }
    ...
    do { if ( ((0x80U | 0x40U) & 0x80U) && ((0x80U | 0x40U) & 0x80U) && ((s16_t)((0x80U | 0x40U) & 0x03) >= 0x00)) { do {printf ("tcp_enqueue: queueing %" "8ld" ":%" "8ld" " (0x%" "4x" ")\n", ntohl(seg->tcphdr->seqno), ntohl(seg->tcphdr->seqno) + ((seg)->len + (((ntohs(((seg)->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 0x01U || (ntohs(((seg)->tcphdr)->_hdrlen_rsvd_flags) & 0x3fU) & 0x02U)? 1: 0)), (u16_t)flags);} while(0); if ((0x80U | 0x40U) & 0x08U) { while(1); } } } while(0);
  ...
  if (useg != 0 &&
    ...
    do { if ( ((0x80U | 0x40U | 0x20U) & 0x80U) && ((0x80U | 0x40U | 0x20U) & 0x80U) && ((s16_t)((0x80U | 0x40U | 0x20U) & 0x03) >= 0x00)) { do {printf ("tcp_enqueue: chaining segments, new len %" "4d" "\n", useg->len);} while(0); if ((0x80U | 0x40U | 0x20U) & 0x08U) { while(1); } } } while(0);
    if (seg == queue) {
      seg = useg;
      seglen = useg->len;
    }
  ...
  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_enqueue: %" "4d" " (after enqueued)\n", pcb->snd_queuelen);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
...
memerr:
  ...
  do { if ( ((0x80U | 0x20U) & 0x80U) && ((0x80U | 0x20U) & 0x80U) && ((s16_t)((0x80U | 0x20U) & 0x03) >= 0x00)) { do {printf ("tcp_enqueue: %" "4d" " (with mem err)\n", pcb->snd_queuelen);} while(0); if ((0x80U | 0x20U) & 0x08U) { while(1); } } } while(0);
  return -1;
}
...
tcp_output(struct tcp_pcb *pcb)
{
  ...
  if (pcb->flags & ((u8_t)0x02U) &&
    ...
    if (p == 0) {
      do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_output: (ACK) could not allocate pbuf\n");} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
      return -2;
    }
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_output: sending ACK for %" "8ld" "\n", pcb->rcv_nxt);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
...
#line 516 "..\\lwIP\\src\\core\\tcp_out.c"
  ...
  if (seg == 0) {
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_output: nothing to send (%p)\n", (void*)pcb->unsent);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);

  }


  if (seg == 0) {
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_output: snd_wnd %" "4d" ", cwnd %" "4d" ", wnd %" "8ld" ", seg == NULL, ack %" "8ld" "\n", pcb->snd_wnd, pcb->cwnd, wnd, pcb->lastack);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);



  } else {
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_output: snd_wnd %" "4d" ", cwnd %" "4d" ", wnd %" "8ld" ", effwnd %" "8ld" ", seq %" "8ld" ", ack %" "8ld" "\n", pcb->snd_wnd, pcb->cwnd, wnd, ntohl(seg->tcphdr->seqno) - pcb->lastack + seg->len, ntohl(seg->tcphdr->seqno), pcb->lastack);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
  ...
  while (seg != 0 &&
    ...
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_output: snd_wnd %" "4d" ", cwnd %" "4d" ", wnd %" "8ld" ", effwnd %" "8ld" ", seq %" "8ld" ", ack %" "8ld" ", i %" "4d" "\n", pcb->snd_wnd, pcb->cwnd, wnd, ntohl(seg->tcphdr->seqno) + seg->len - pcb->lastack, ntohl(seg->tcphdr->seqno), pcb->lastack, i);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
...
#line 676 "..\\lwIP\\src\\core\\tcp_out.c"
  ...
  if (pcb->rttest == 0) {
    ...
    do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_output_segment: rtseq %" "8ld" "\n", pcb->rtseq);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
  }
  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_output_segment: %" "8ld" ":%" "8ld" "\n", htonl(seg->tcphdr->seqno), htonl(seg->tcphdr->seqno) + seg->len);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
  ...
  u16_t local_port, u16_t remote_port)
{
  ...
  pbuf_free(p);
  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_rst: seqno %" "8ld" " ackno %" "8ld" ".\n", seqno, ackno);} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);
}
...
tcp_keepalive(struct tcp_pcb *pcb)
{
  ...
  do { if ( ((0x80U) & 0x80U) && ((0x80U) & 0x80U) && ((s16_t)((0x80U) & 0x03) >= 0x00)) { do {printf ("tcp_keepalive: sending KEEPALIVE probe to %" "4d" ".%" "4d" ".%" "4d" ".%" "4d" "\n", ((u16_t)(ntohl((&pcb->remote_ip)->addr) >> 24) & 0xff), ((u16_t)(ntohl((&pcb->remote_ip)->addr) >> 16) & 0xff), ((u16_t)(ntohl((&pcb->remote_ip)->addr) >> 8) & 0xff), ((u16_t)(ntohl((&pcb->remote_ip)->addr)) & 0xff));} while(0); if ((0x80U) & 0x08U) { while(1); } } } while(0);

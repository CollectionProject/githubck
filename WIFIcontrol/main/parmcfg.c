...
#ifndef __AD_HOC__
char marvel_mode='0';
char marvel_ssid[32]={"LXHZ"};//{"TP-LINK_243C64"};//{"TP-LINK_709202"};//{"MERCURY_59E034"};			//无线路由器的名字
char marvel_key[32]= {"1234567890123"};			//无限路由器的密码
char wireless_ip[4]={192,168,1,8};			//一个与路由器处于同一网段的可用且有效的IP地址
char wireless_mask[4]={255,255,255,0};			//子网掩码，默认不用修改
char wireless_gw[4]={192,168,1,1};                      //网关地址，一般为路由器的地址
char wireless_dns[4]={192,168,1,1};            // DNS也可不必更改
...
char wireless_gw[4]={192,168,1,1};						//网关不用更改
...
char marvel_mode='1';
char marvel_ssid[32]={"WIFIBOARD_ADHOC"};
...
char marvel_mode='0';
char marvel_ssid[32]={"TPLINK"};		//无线路由器的名字
char marvel_key[32]={"1234567890123"};		//无限路由器的密码
char wireless_ip[4]={192,168,1,43};		//一个与路由器处于同一网段的可用且有效的IP地址
char wireless_mask[4]={255,255,255,0};		//子网掩码，默认不用修改
char wireless_gw[4]={192,168,1,1};		//网关地址，一般为路由器的地址
char wireless_dns[4]={202,99,96,68}; // DNS也可不必更改
char wireless_mac[6]={0x00,0x1D,0x2f,0x00,0x4e,0x2d}; //mac 地址可以不必更改
...
/*
        ...
        比如你要想建立一个SSID名为WIFIBOARD_ADHOC且密码为1234567890123 ip 地址为 192.168.1.10 的AD-HOC 网络那么
        default_cfg[] 对应的字符串应为
        {"Route?NET=1&SSID=WIFIBOARD_ADHOC&KEY=1234567890123&WIP1=192&WIP2=168&WIP3=001&WIP4=010&MASK1=255&MASK2=255&MASK3=255&MASK4=000&GW1=192&GW2=168&GW3=001&GW4=001&DNS1=202&DNS2=096&DNS3=134&DNS4=133&WMAC0=00&WMAC1=1A&WMAC2=6B&WMAC3=6E&WMAC4=82&WMAC5=0E&OK=%B1%A3%B4%E6"};
